...
export default function RegisterScreen() {
  ...
  // Clear any leftover error from a previous screen (e.g. coming from login)
        ...
        >
          ...
          <View style={s.content}>
            ...
            <Text style={s.subtitle}>
              Rejoignez la communauté des photographes
            </Text>
            ...
            <Text style={s.terms}>
              ...
              <Text style={s.termsLink}>Conditions d'utilisation</Text> et notre{" "}
            ...
            >
              <Text style={s.switchText}>
                Déjà un compte ?{" "}
                <Text style={s.switchBold}>Se connecter</Text>
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
